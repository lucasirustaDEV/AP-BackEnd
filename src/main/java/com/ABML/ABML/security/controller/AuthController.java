package com.ABML.ABML.security.controller;
...
import com.ABML.ABML.security.dto.JwtDto;
import com.ABML.ABML.security.dto.LoginUsuario;
import com.ABML.ABML.security.dto.NuevoUsuario;
import com.ABML.ABML.security.jwt.JwtProvider;
import com.ABML.ABML.security.service.RolService;
import com.ABML.ABML.security.service.UsuarioService;
...
public class AuthController {
    ...
    public ResponseEntity<?> nuevo(@Valid @RequestBody NuevoUsuario nuevoUsuario, BindingResult bindingResult){
        ...
        if (usuarioService.existsByNombreUsuario(nuevoUsuario.getNombreUsuario()))
            return new ResponseEntity(new Mensaje("Nombre se usuario existente"), HttpStatus.BAD_REQUEST);
